...
class TaxonomyDB(collections.Mapping):
    ...
    def commonly_used_organisms(self, new_db_path):
        from orangecontrib.bio.ncbi.taxonomy import common_taxids
...
if __name__ == "__main__":
    from orangecontrib.bio.ncbi.taxonomy import TaxonomyDB
    test = TaxonomyDB("/home/koki/.Orange3/buffer/serverfiles-bio/Taxonomy/ncbi-taxonomy.sqlite")
    test.commonly_used_organisms("/home/koki/.Orange3/buffer/serverfiles-bio/Taxonomy/ncbi-common-taxonomy.sqlite")